...
if(isset($_POST['submit'])&& $input2<10){
	...
	elseif($table[0][0] == $table[1][0] == "X" && $input3 == 3){
		$table[0][2] = "X";
		$table[0][1] = "O";}

	//**************************Computer wins X = (1,4)***********************************
	elseif($table[0][0] == $table[1][0] == "X" && $input3 == 2){
		$table[0][1] = "X";
		$table[0][2] = "O";
		echo '<script>alert("Computer wins");window.location.tic.php;</script>';}
	elseif($table[0][0] == $table[1][0] == "X" && $input3 == 6){
		$table[1][2] = "X";
		$table[0][2] = "O";
		echo '<script>alert("Computer wins");window.location.tic.php;</script>';}
	elseif($table[0][0] == $table[1][0] == "X" && $input3 == 8){
		$table[2][1] = "X";
		$table[0][2] = "O";
		echo '<script>alert("Computer wins");window.location.tic.php;</script>';}
	elseif($table[0][0] == $table[1][0] == "X" && $input3 == 9){
		$table[2][2] = "X";
		$table[0][2] = "O";
		echo '<script>alert("Computer wins");window.location.tic.php;</script>';}
	//************************************************************************************

	elseif($table[0][0] == $table[1][2] == "X" && $input3 == 7){
		$table[2][0] = "X";
		$table[0][1] = "O";}

	//**************************Computer wins X = (1,6)***********************************
	elseif($table[0][0] == $table[1][2] == "X" && $input3 == 2){
		$table[0][1] = "X";
		$table[2][0] = "O";
		echo '<script>alert("Computer wins");window.location.tic.php;</script>';}
	elseif($table[0][0] == $table[1][2] == "X" && $input3 == 4){
		$table[1][0] = "X";
		$table[2][0] = "O";
		echo '<script>alert("Computer wins");window.location.tic.php;</script>';}
	elseif($table[0][0] == $table[1][2] == "X" && $input3 == 8){
		$table[2][1] = "X";
		$table[2][0] = "O";
		echo '<script>alert("Computer wins");window.location.tic.php;</script>';}
	elseif($table[0][0] == $table[1][2] == "X" && $input3 == 9){
		$table[2][2] = "X";
		$table[2][0] = "O";
		echo '<script>alert("Computer wins");window.location.tic.php;</script>';}
	//************************************************************************************

	elseif($table[0][0] == $table[2][0] == "X" && $input3 == 6){
		$table[1][2] = "X";
		$table[0][1] = "O";}
	
	//**************************Computer wins X = (1,7)***********************************
	elseif($table[0][0] == $table[2][0] == "X" && $input3 == 2){
		$table[0][1] = "X";
		$table[1][2] = "O";
		echo '<script>alert("Computer wins");window.location.tic.php;</script>';}
	elseif($table[0][0] == $table[2][0] == "X" && $input3 == 3){
		$table[0][2] = "X";
		$table[1][2] = "O";
		echo '<script>alert("Computer wins");window.location.tic.php;</script>';}
	elseif($table[0][0] == $table[2][0] == "X" && $input3 == 8){
		$table[2][1] = "X";
		$table[1][2] = "O";
		echo '<script>alert("Computer wins");window.location.tic.php;</script>';}
	elseif($table[0][0] == $table[2][0] == "X" && $input3 == 9){
		$table[2][2] = "X";
		$table[1][2] = "O";
		echo '<script>alert("Computer wins");window.location.tic.php;</script>';}
	//************************************************************************************
