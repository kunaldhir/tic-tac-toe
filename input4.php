...
if(isset($_POST['submit'])&& $input3<10){
	...
	elseif($table[1][0] == "X" && $table[1][1] == "X" && $table[2][2] =="X" && $input4 == 2){
		$table[0][1] = "X";
		$table[2][0] = "O";
		echo '<script>alert("Match Drawn");</script>';}

	//**************************Computer wins X = (4,5,9)***********************************
	elseif($table[1][0] == "X" && $table[1][1] == "X" && $table[2][2] =="X" && $input4 == 7){
		$table[2][0] = "X";
		$table[0][1] = "O";
		echo '<script>alert("Computer Wins");</script>';}
	elseif($table[1][0] == "X" && $table[1][1] == "X" && $table[2][2] =="X" && $input4 == 8){
		$table[2][1] = "X";
		$table[0][1] = "O";
		echo '<script>alert("Computer Wins");</script>';}
	//************************************************************************************

	elseif($table[1][0] == "X" && $table[1][2] == "X" && $table[2][0] =="X" && $input4 == 9){
		$table[2][2] = "X";
		$table[2][1] = "O";
		echo '<script>alert("Match Drawn");</script>';}

	//**************************Computer wins X = (4,6,7)***********************************
	elseif($table[1][0] == "X" && $table[1][2] == "X" && $table[2][0] =="X" && $input4 == 2){
		$table[0][1] = "X";
		$table[2][2] = "O";
		echo '<script>alert("Computer Wins");</script>';}
	...
	elseif($table[1][0] == "X" && $table[2][0] == "X" && $table[0][1] =="X" && $input4 == 9){
		$table[2][2] = "X";
		$table[2][1] = "O";
		echo '<script>alert("Match Drawn");</script>';}

	//**************************Computer wins X = (4,7,2)***********************************
	elseif($table[1][0] == "X" && $table[2][0] == "X" && $table[0][1] =="X" && $input4 == 6){
		$table[1][2] = "X";
		$table[2][2] = "O";
		echo '<script>alert("Computer Wins");</script>';}
	elseif($table[1][0] == "X" && $table[2][0] == "X" && $table[0][1] =="X" && $input4 == 8){
		$table[2][1] = "X";
		$table[2][2] = "O";
		echo '<script>alert("Computer Wins");</script>';}
	//************************************************************************************

	elseif($table[1][0] == "X" && $table[2][1] == "X" && $table[0][1] =="X" && $input4 == 9){
		$table[2][2] = "X";
		$table[2][0] = "O";
		echo '<script>alert("Match Drawn");</script>';}

	//**************************Computer wins X = (4,8,2)***********************************
	elseif($table[1][0] == "X" && $table[2][1] == "X" && $table[0][1] =="X" && $input4 == 6){
		$table[1][2] = "X";
		$table[2][2] = "O";
		echo '<script>alert("Computer Wins");</script>';}
	elseif($table[1][0] == "X" && $table[2][1] == "X" && $table[0][1] =="X" && $input4 == 7){
		$table[2][0] = "X";
		$table[2][2] = "O";
		echo '<script>alert("Computer Wins");</script>';}
	//************************************************************************************
	...
	elseif($table[1][0] == "X" && $table[2][2] == "X" && $table[0][1] =="X" && $input4 == 6){
		...
		$table[2][0] = "O";
		echo '<script>alert("Computer Wins");</script>';}
	elseif($table[1][0] == "X" && $table[2][2] == "X" && $table[0][1] =="X" && $input4 == 8){
		$table[2][1] = "X";
		$table[2][0] = "O";
		echo '<script>alert("Computer Wins");</script>';}
	//************************************************************************************
